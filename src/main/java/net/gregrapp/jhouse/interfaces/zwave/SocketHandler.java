...
public class SocketHandler extends SimpleChannelUpstreamHandler
{
      ...
      throws Exception
  {
    ...
    }, FrameLayerImpl.RECONNECT_DELAY, TimeUnit.SECONDS);
      ...
      throws Exception
  {
    ...
    while (buf.readable())
    {
      logger.trace("Reading byte from buffer and sending to callback");
      callback.byteReceived(buf.readUnsignedByte());
    }
    logger.exit();
  }
